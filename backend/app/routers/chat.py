...
from app.services.chat_service import HealthcareAgent, AgentResponse, DietPlan
import json
...
async def process_query(request: ChatRequest):
    ...
    try:
        ...
        if 'diet_plan' in responses and responses['diet_plan']:
            ...
            if 'diet_plan' in diet_plan_data and isinstance(diet_plan_data['diet_plan'], DietPlan):
