    ...
    def __init__(self):
        ...
        self.patterns = {
            ...
            "name_line": [
                ...
                (
                    r"(?i)^.*?(?:patient\s+name|name|patient)[\s:]+[A-Z][A-Z.\s]+.*?$",
                    "",
                    re.MULTILINE,
                ),
                (
                    r"(?i)^.*?\b(?:MR|DR|MS|MRS|MISS)\.?\s+[A-Z][A-Z.\s]+.*?$",
                    "",
                    re.MULTILINE,
                ),
            ],
            ...
            "location_line": [
                ...
                (
                    r"(?i)^.*?(?:location|address|city|area)[\s:]+[A-Z][A-Z\s,]+.*?$",
                    "",
                    re.MULTILINE,
                ),
            ],
            "id_line": [
                ...
                (
                    r"(?i)^.*?(?:patient\s+id|mrn|medical\s+record|uhid|id|patient\s+number)[\s:]+[A-Z0-9-]+.*?$",
                    "",
                    re.MULTILINE,
                ),
            ],
            "dob_line": [
                ...
                (
                    r"(?i)^.*?(?:dob|d\.o\.b|date\s+of\s+birth|birth\s+date)[\s:]+\d{1,2}[-/]\d{1,2}[-/]\d{2,4}.*?$",
                    "",
                    re.MULTILINE,
                ),
            ],
            "contact_line": [
                ...
                (
                    r"(?i)^.*?(?:phone|tel|mobile|contact|email|e-mail)[\s:]+.*?$",
                    "",
                    re.MULTILINE,
                ),
            ],
            ...
            for item in pattern_list:
                ...
                if matches:
                    ...
                    sanitized_text = re.sub(
                        pattern, replacement, sanitized_text, flags=flags
                    )
