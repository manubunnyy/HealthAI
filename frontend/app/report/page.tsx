    ...
    return (
        <div className="max-w-5xl mx-auto">
            <header className="mb-8 text-center">
                ...
                <p className="text-gray-400">Upload your medical report for instant AI analysis</p>
            </header>
            ...
            {!results ? (
                <GlassCard className="max-w-xl mx-auto text-center py-12">
                    <div className="mb-8">
                        ...
                        <h3 className="text-xl font-semibold text-white mb-2">Upload Report</h3>
                    ...
                    <div className="flex flex-col items-center gap-4 max-w-xs mx-auto">
                        ...
                        <GlassButton onClick={handleAnalyze} disabled={!file || isLoading} className="w-full">
                    ...
                    <GlassCard className="lg:col-span-3 min-h-[500px]">
                        {activeTab === 'summary' && results.summary_agent && (
                            <div>
                                ...
                                <div className="prose prose-invert max-w-none">
                                    <ReactMarkdown remarkPlugins={[remarkGfm]}>{results.summary_agent.content}</ReactMarkdown>
                                </div>
                            </div>
                        )}
                        ...
                        {activeTab === 'positive' && results.positive_analyzer && (
                            <div>
                                ...
                                <div className="prose prose-invert max-w-none">
                                    <ReactMarkdown remarkPlugins={[remarkGfm]}>{results.positive_analyzer.content}</ReactMarkdown>
                                </div>
                            </div>
                        )}
                        ...
                        {activeTab === 'negative' && results.negative_analyzer && (
                            <div>
                                ...
                                <div className="prose prose-invert max-w-none">
                                    <ReactMarkdown remarkPlugins={[remarkGfm]}>{results.negative_analyzer.content}</ReactMarkdown>
                                </div>
                            </div>
                        )}
                    </GlassCard>
