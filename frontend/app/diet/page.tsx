    ...
    return (
        <div className="max-w-4xl mx-auto">
            <header className="mb-8 text-center">
                ...
                <p className="text-gray-400">AI-powered food analysis and meal planning</p>
            </header>
            ...
            {activeTab === 'scan' ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <GlassCard className="flex flex-col items-center justify-center min-h-[400px]">
                        ...
                        <div className="flex gap-4 w-full mt-4">
                            ...
                            <GlassButton onClick={handleAnalyzeFood} disabled={!selectedImage || isLoading} className="flex-1">
                ...
                <GlassCard>
                    <h3 className="text-xl font-semibold mb-4 text-white">Personalized Meal Plan</h3>
                    <p className="text-gray-400 mb-4">Tell us about your available ingredients, dietary preferences, and goals.</p>
                    ...
                    <GlassButton onClick={handleGeneratePlan} disabled={isLoading || !planInput.trim()} className="w-full mb-8">
                        {isLoading ? 'Generating Plan...' : 'Generate Meal Plan'}
                    </GlassButton>

                    {generatedPlan && (
                        <div className="mt-8 pt-8 border-t border-glass-border">
                            <h4 className="text-lg font-semibold mb-4 text-green-400">Your Custom Plan</h4>
                            <div className="prose prose-invert max-w-none">
