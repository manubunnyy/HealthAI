...
const LeafletMap = dynamic(() => import("../../components/LeafletMap"), {
  ssr: false,
  loading: () => (
    <div className="h-[300px] w-full bg-glass-100 animate-pulse rounded-xl flex items-center justify-center text-gray-500">
      Loading Map...
    </div>
  ),
});
...
export default function ESafePage() {
  const [step, setStep] = useState<"type" | "location" | "details" | "success">(
    "type",
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(
        err.message || "Failed to send emergency alert. Please try again.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-2xl mx-auto space-y-8 relative">
        ...
        <div className="text-center space-y-2 pt-8 md:pt-0">
          ...
          <p className="text-gray-300">
            Get help quickly in emergency situations
          </p>
        </div>
        ...
        {step === "type" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {emergencyTypes.map((type) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${type.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                />
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <type.icon
                    size={48}
                    className={`${type.color} group-hover:scale-110 transition-transform`}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <MapPin />{" "}
                      {location ? "Update Location" : "Share Current Location"}
                    </>
                  )}
                </button>
                <button
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <p className="text-gray-400">
                    Click to upload photos of the situation
                  </p>
                  {photos.length > 0 && (
          ...
          <div className="text-center space-y-6 animate-in zoom-in duration-300">
            ...
            <div className="glass-panel p-8 border-green-500/30 space-y-4">
              ...
              <p className="text-gray-400">
                ...
                <span className="text-white font-bold">5-15 minutes</span>
              </p>
