  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://healthai-b6y2.onrender.com/prediction/analyze",
        payload,
      );
    ...
    <div className="max-w-4xl mx-auto">
      <header className="mb-8 text-center">
        ...
        <p className="text-gray-400">
          Assess your health risks with AI-powered analysis
        </p>
      </header>
              ...
              <>
                ...
                <div>
                  ...
                  <GlassInput
                    ...
                    type="number"
                    value={formData.glucose_post_meal}
                    onChange={handleInputChange}
                    placeholder="140"
                  />
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {result.insights.map((insight: string, idx: number) => (
                    <li
                      key={idx}
                      className="text-sm text-gray-300 bg-glass-100 p-3 rounded-lg border-l-2 border-blue-500"
                    >
                      {insight}
                    </li>
                  ))}
