...
export default function Home() {
  const features = [
    ...
    {
      title: "eSafe",
      description: "Alert emergency services with precise directions and incident details",
      icon: <Ambulance className="w-8 h-8 mb-4 text-red-500" />,
      href: "/esafe",
    ...
    <div className="max-w-7xl mx-auto">
      <header className="mb-12 md:mb-20 text-center px-4">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
          Your intelligent companion for a healthier life. Experience the future
